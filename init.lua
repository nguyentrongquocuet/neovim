-- Dont forget to install ripgrep for telescope word searching to work
-- Install packer
...
-- Toggle comment
vim.api.nvim_set_keymap('n', '++', 'gbc', { silent = true })
vim.api.nvim_set_keymap('v', '++', 'gb', { silent = true })
